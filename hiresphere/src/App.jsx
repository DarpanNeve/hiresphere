          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
            <div className="text-center">
              ...
              <div className="flex justify-center gap-6">
                <button
                  className="group bg-white text-indigo-900 px-8 py-4 rounded-xl font-bold hover:bg-indigo-50 transition-colors flex items-center text-lg shadow-lg hover:shadow-xl"
